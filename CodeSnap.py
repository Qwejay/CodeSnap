...
class CodeSnapApp:
    def __init__(self, root):
        self.root = root
        self.root.title("代码缩进工具 CodeSnap 1.0 ———— QwejayHuang")
        self.root.geometry("800x500")  # 设置窗口初始大小
        self.root.iconbitmap("icon.ico")  # 设置程序图标（需准备 icon.ico 文件）
    ...
    def setup_ui(self):
        ...
        # 添加“缩进”标签
        indent_label_left = ctk.CTkLabel(input_frame, text="缩进", font=("Roboto", 12))
        ...
        # 快捷键绑定
        self.root.bind("<Control-Return>", lambda event: self.add_indentation())  # Ctrl + Enter
        self.root.bind("<Control-l>", lambda event: self.clear_text())  # Ctrl + L
        ...
        self.root.bind("<Control-a>", lambda event: self.select_all())  # Ctrl + A
    ...
    def add_indentation(self):
        ...
        self.code_text.insert("1.0", indented_code.rstrip())  # 去除末尾多余的空行
    ...
    def copy_to_clipboard(self):
        ...
        try:
            ...
            all_text = self.code_text.get("1.0", "end")
            self.root.clipboard_clear()
    ...
    def paste_from_clipboard(self):
        ...
        try:
            ...
            try:
                ...
                pass  # 如果没有选中的文本，跳过删除操作
            self.code_text.insert("insert", clipboard_text)
